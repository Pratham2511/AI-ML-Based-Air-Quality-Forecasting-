...
export const COMPARISON_30_DAYS = Array.from({ length: 30 }, (_, i) => ({
  ...
  Hyderabad: 10 + Math.random() * 20,
}));

export const RADAR_DATA = [
  { subject: 'PM2.5', Mumbai: 85, Hyderabad: 30, fullMark: 100 },
  { subject: 'PM10', Mumbai: 70, Hyderabad: 40, fullMark: 100 },
  { subject: 'NO2', Mumbai: 60, Hyderabad: 15, fullMark: 100 },
  { subject: 'SO2', Mumbai: 20, Hyderabad: 10, fullMark: 100 },
  { subject: 'CO', Mumbai: 45, Hyderabad: 25, fullMark: 100 },
  { subject: 'O3', Mumbai: 55, Hyderabad: 20, fullMark: 100 },
];
